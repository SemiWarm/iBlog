...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <div id="iBlogContainer">
            </div>

            <!-- more -->

            <div class="row">
                <div class="col-lg-12 alert alert-danger text-center" id="noMoreInfo" role="alert">没有更多内容了</div>
            </div>

            <div class="row">
                <%--分页按钮--%>
                <div class="col-lg-12 btn btn-info" id="btnMore" role="button">
                    加载更多
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var iBlogContainer = $('#iBlogContainer');
    var noMoreInfo = $('#noMoreInfo');
    var btnMore = $('#btnMore');
    var blogsPageInfo;
    $(function () {
        ...
        $.ajax({
            type: 'get',
            url: '<%=request.getContextPath()%>/blogs/pageNum/1/pageSize/2',
            async: false,
    ...
    btnMore.bind('click', function () {
        ...
        $.ajax({
            type: 'get',
            url: "<%=request.getContextPath()%>/blogs/pageNum/" + blogsPageInfo["nextPage"] + "/pageSize/2",
            async: false,
            success: function (pageInfo) {
                blogsPageInfo = pageInfo;
                console.log(blogsPageInfo["list"]);
